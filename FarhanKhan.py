...
logo = """\n\x1b[1;91m\n\x1b[1;92m\n\x1b[1;96m\n\x1b[1;92m         {|} {|}  {|} {|}{|}{|} {|}{|}{|}\n\x1b[1;97m         {|} {|}  {|}    {|}       {|}\n\x1b[1;93m         {|} {|}  {|}    {|}       {|}\n\x1b[1;96m         {|} {|}  {|}    {|}       {|}\n\x1b[1;94m     {|}{|}   {|}{|}     {|}       {|}\n\x1b[1;93m\n\x1b[1;92m             Farhan Khan Kakar~\n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : FarhanKhan\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/Farhan-Khan\n\x1b[1;97m\xe2\x9e\xa3 Whatsapp  Number : +48699526801\n\x1b[1;91m-----------------------------------------------"""
...
def test():
    ...
    if gg == '1':
        ...
        if bit == '64bit':
            from Farhan import reg
            reg()
        elif bit == '32bit':
            from Khan import reg
            reg()
    else:
